...
courses = data['level'].value_counts()

x = []
y = []

for index in courses.index.values:
    x.append(index)
    y.append(courses[index])
...
print (tls.get_embed(py.plot(fig, filename = 'aicte_courses_pie', show_link = False)))
