...
with open('cities_r2.csv', 'r') as csvfile:
    ...
    for row in filereader:
        ...
        city_literates_count[name_of_city] = float(row['literates_total'])
...
for city in city_count:
    # print "city_literates_count[city]: " + str(city_literates_count[city])
    # print "city_count[city] : " + str(city_count[city])
    city_opacity[city] = float(city_literates_count[city]/city_count[city])
...
layout = graph_objs.Layout(
    title = "Distribution of<br>Literacy in India",
    height=700,
    width=500,
    autosize=True,
    hovermode='closest',
...
print (tls.get_embed(py.plot(fig, filename='literates_map')))
