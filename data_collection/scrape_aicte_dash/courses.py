...
browser = getBrowser()
browser.get('http://www.aicte-india.org/dashboard/pages/approved.php?aicteid=1-2813783364&course=&year=2016-2017')
...
while(True):
    ...
    for tr in tbody.find_all('tr'):
        ...
        row_data = {}
        i = 0
        for label in ['programme', 'university', 'level_of_course', 'course', 'shift', 'full/part_time', 'intake', 'enrollment']:
